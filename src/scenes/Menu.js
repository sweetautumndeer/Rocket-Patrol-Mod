...
class Menu extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio('sfx_rocket', './assets/Ice.wav');
    }
    ...
    create() {
        ...
        this.add.text(game.config.width/2, game.config.height/2, 'Use mouse to move & (mouse1) to fire', menuConfig).setOrigin(0.5);
